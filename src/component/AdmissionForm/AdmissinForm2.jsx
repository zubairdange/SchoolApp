  ...
  return (
    <div>
      ...
      >
        ...
        <tr>
          <td colSpan="1">Hall Ticket No. </td>
          <td colSpan="1">
            <Form.Control size="sm" type="text" />
          </td>
          <td colSpan="1">Total Marks Obtained :</td>
          <td colSpan="1">
            <Form.Control size="sm" type="text" />
          </td>
        </tr>
        <tr style={{ backgroundtdor: "lightgray" }}>
          <td colSpan="1">Maximum Marks :</td>
          <td colSpan="1">
            <Form.Control size="sm" type="text" />
          </td>
          <td colSpan="1">Passing Month : </td>
          <td colSpan="1">
            <Form.Control size="sm" type="text" />
          </td>
          ...
          <td colSpan="1">Percentage Marks Scored: </td>
          <td colSpan="1">
            <Form.Control size="sm" type="text" />
          </td>
        ...
        <td colSpan="8">
          <h4>
            ...
            subject at inter /12th/Diploma std.examination in the following
            table /candidte seeking direct year admission can write diploma /
            degree subjects and marks in the table.
          </h4>
        </td>
        <tr>
